...
npc_t *get_generic_npcs()
{
    ...
    HASH_ADD_STR(inventory_frenemy3, item_id,book_item);
    item_t *sword_item = item_new("sword","long silver sword", "level 1 sword");
    HASH_ADD_STR(inventory_frenemy3, item_id, sword_item);
