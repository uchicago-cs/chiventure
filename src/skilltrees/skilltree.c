...
skill_node_t** get_acquired_skill_prereqs(skill_tree_t* tree,
    ...
    skill_node_t** prereqs = get_all_skill_prereqs(tree, sid, &nprereqs);
    ...
    skill_node_t** acquired = (skill_t**)malloc(nprereqs * sizeof(skill_t*));
    if (acquired == NULL) {
        fprintf(stderr, "get_acquired_skill_prereqs: mallocing acquired failed\n");
