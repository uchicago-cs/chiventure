...
convo_t *create_steve_conversation()
{
    ...
    add_node(c, "1", "Pick an item: a sword or a shield?", NEUTRAL);
    add_node(c, "2a", "I see you prefer the path of offence. Do you prefer a longsword or a scimitar? Or do you change your mind?", NEUTRAL);
    add_node(c, "3a", "One longsword coming up.", NEUTRAL);
    add_node(c, "3b", "One scimitar coming up.", NEUTRAL);
    add_node(c, "2b", "Ah, I see you prefer the path of defence. Clever choice.", NEUTRAL);
    add_edge(c, "Sword", "1", "2a", NULL, NEUTRAL);
    add_edge(c, "Shield", "1", "2b", NULL, NEUTRAL);
    add_edge(c, "Longsword", "2a", "3a", NULL, NEUTRAL);
    add_edge(c, "Scimitar", "2a", "3b", NULL, NEUTRAL);
    add_edge(c, "I change my mind: I want a shield", "2a", "2b", NULL, NEUTRAL);
...
convo_t *create_oak_conversation()
{
    ...
    add_node(c, "2a", "So your name is Red?", NEUTRAL);
    add_node(c, "2b", "So your name is Ash?", NEUTRAL);
    ...
    add_edge(c, "Yes", "2a", "3a", NULL, NEUTRAL);
    add_edge(c, "Yes", "2b", "3b", NULL, NEUTRAL);
    add_edge(c, "Yes", "2c", "3c", NULL, NEUTRAL);
    add_edge(c, "No", "2a", "1.5", NULL, NEUTRAL);
    add_edge(c, "No", "2b", "1.5", NULL, NEUTRAL);
    add_edge(c, "No", "2c", "1.5", NULL, NEUTRAL);

    add_edge(c, "Blue", "3a", "4a", NULL, NEUTRAL);
    add_edge(c, "Gary", "3a", "4b", NULL, NEUTRAL);
    add_edge(c, "Blue", "3b", "4a", NULL, NEUTRAL);
