...
/* See npc.h */
int npc_init(npc_t *npc, char *npc_id, int health, class_t *class, stats_t *stats) //TODO-convo_t *dialogue)
{
    assert(npc != NULL);
...
/* See npc.h */
npc_t* npc_new(char *npc_id, int health, class_t *class, stats_t *stats)
{
    npc_t *npc;
