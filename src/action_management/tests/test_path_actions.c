...
Test(path_actions, validate_path)
{
    ...
    int add1, set1, add2, add3, connec_check1, connec_check2;
    ...
    add1 = add_player_to_game(game_test, player_test);
    set1 = set_curr_player(game_test, player_test);
    add2 = add_room_to_game(game_test, room_origin);
    add3 = add_room_to_game(game_test, room_north);
