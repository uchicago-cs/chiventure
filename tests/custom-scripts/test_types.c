...
{   
    object_t ot = obj_t_bool(true, "../../../tests/custom-scripts/Lua_file/bool_t_test.lua");
    cr_assert_eq(ot.type, TYPE_BOOL, "obj_t_bool: failed type assignment");
...
{   
    object_t ot = obj_t_char('a', "../../../tests/custom-scripts/Lua_file/char_t_test.lua");
    cr_assert_eq(ot.type, TYPE_CHAR, "obj_t_char: failed type assignment");
...
{   
    object_t ot = obj_t_int(10, "../../../tests/custom-scripts/Lua_file/int_t_test.lua");
    cr_assert_eq(ot.type, TYPE_INT, "obj_t_int: failed type assignment");
...
{   
    object_t ot = obj_t_str('testing', "../../../tests/custom-scripts/Lua_file/str_t_test.lua");
    cr_assert_eq(ot.type, TYPE_STR, "obj_t_str: failed type assignment");
...
{
    object_t ot = int_t_new(10, "../../../tests/custom-scripts/Lua_file/int_t_test.lua");
    int rv = int_t_get (ot);
