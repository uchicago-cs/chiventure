...
int check_npc_action(chiventure_ctx_t *c, action_type_t *a, npc_t *npc, char **ret_string)
{
    return;
}
...
Test(npc_actions, not_allowed_direct_1)
{
}
...
Test(npc_actions, effect_not_applied_1)
{
}
