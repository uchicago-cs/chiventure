...
Test(battle_logic, target_exists)
{
    ...
    combatant_t *p = combatant_new("Player", true, NULL, NULL, NULL, NULL, NONE);
    DL_APPEND(phead, p);
    ...
    c1 = combatant_new("Goblin Gary", false, NULL, calloc(1, sizeof(stat_t)), NULL, NULL, NONE);
    c2 = combatant_new("Orc John", false, NULL, calloc(1, sizeof(stat_t)), NULL, NULL, NONE);
    DL_APPEND(ehead, c1);
    DL_APPEND(ehead, c2);
...
Test(battle_logic, battle_over_by_player)
{
    ...
    estats->hp = 10;
    combatant_t *p = combatant_new("Player", true, NULL, pstats, NULL, NULL, NONE);
    combatant_t *e = combatant_new("Enemy", false, NULL, estats, NULL, NULL, NONE);
...
Test(battle_logic, battle_over_by_enemy)
{
    ...
    combatant_t *p = combatant_new("Player", true, NULL, pstats, NULL, NULL, NONE);
    combatant_t *e = combatant_new("Enemy", false, NULL, estats, NULL, NULL, NONE);
    combatant_t *e1 = combatant_new("Enemy", false, NULL, estats1, NULL, NULL, NONE);
    combatant_t *e2 = combatant_new("Enemy", false, NULL, estats2, NULL, NULL, NONE);
...
Test(battle_logic, enemy_goes_first)
{
    ...
    combatant_t *c1;
    combatant_t *c2;
    c1 = combatant_new("Goblin Gary", false, NULL, estats2, NULL, NULL, NONE);
    c2 = combatant_new("Orc John", false, NULL, estats, NULL, NULL, NONE);
    cr_assert_not_null(c1, "combatant_new() failed");
    cr_assert_not_null(c2, "combatant_new() failed");
    DL_APPEND(ehead, c1);
    DL_APPEND(ehead, c2);
...
Test(battle_logic, player_goes_first)
{
    ...
    combatant_t *c1;
    combatant_t *c2;
    c1 = combatant_new("Goblin Gary", false, NULL, estats, NULL, NULL, NONE);
    c2 = combatant_new("Orc John", false, NULL, estats2, NULL, NULL, NONE);
    cr_assert_not_null(c1, "combatant_new() failed");
    cr_assert_not_null(c2, "combatant_new() failed");
    DL_APPEND(ehead, c1);
    DL_APPEND(ehead, c2);
...
Test(battle_logic, uses_item_correctly)
{
    ...
    pstats->defense = 15;
    pstats->strength = 15;
    combatant_t *p = combatant_new("Player", true, NULL, pstats, NULL, head, NONE);
    cr_assert_not_null(p, "combatant_new() failed");
...
Test(battle_logic, award_xp)
{
    ...
    stat_t *pstats = calloc(1, sizeof(stat_t));
    pstats->xp = 100;
    combatant_t *p = combatant_new("Player", true, test_class, pstats, NULL, NULL, NONE);
