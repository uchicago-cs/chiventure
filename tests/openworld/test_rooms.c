...
{
    roomspec_t *hash = make_default_room(NULL,"school", NULL, NULL);
...
{
    roomspec_t *hash = make_default_room(NULL,"farmhouse", NULL, NULL);
    cr_assert_not_null(hash, "make_default_room failed");
...
{
    roomspec_t *hash = make_default_room(NULL,"castle", NULL, NULL);
    cr_assert_not_null(hash, "make_default_room failed");
