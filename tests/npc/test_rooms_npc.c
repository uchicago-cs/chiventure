...
Test (npcs_in_room, add_npc_to_room)
{
    ...
    npc_t *npc = npc_new(npc_id, "test npc", "test npc", NULL, NULL, 0);
...
Test (npcs_in_room, npcs_in_room_get_number)
{
    ...
    npc_t *test_npc1 = npc_new(npc_id1, "test npc", "test npc", NULL, NULL, 0);
    ...
    npc_t *test_npc2 = npc_new(npc_id2, "test npc", "test npc", NULL, NULL, 0);
