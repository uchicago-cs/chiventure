...
Test(AST_block_t, new_CONTROL)
{
    ...
    cr_assert_eq(new_ast->block, control_block, "AST_block_new() didn't set 
                 new_ast->block");
    cr_assert_eq(new_ast->block_type, CONTROL, "AST_block_new() didn't set
                 new_ast->block_type");
...
Test(AST_block_t, new_BRANCH)
{
    ...
    cr_assert_eq(new_ast->block, branch_block, "AST_block_new() didn't set
                 new_ast->block");
    cr_assert_eq(new_ast->block_type, BRANCH, "AST_block_new() didn't set
                 new_ast->block_type");
...
Test(AST_block_t, new_ACTION)
{
    ...
    cr_assert_eq(new_ast->block, action_block, "AST_block_new() didn't set
                 new_ast->block");
    cr_assert_eq(new_ast->block_type, ACTION, "AST_block_new() didn't set
                 new_ast->block_type");
...
Test(AST_block_t, new_CONDITIONAL)
{
    ...
    cr_assert_eq(new_ast->block, conditional_block, "AST_block_new() didn't set
                 new_ast->block");
...
Test(control_block_t, new_IF/ELSE)
{
    ...
    cr_assert_eq(new_control->next, next, "control_block_new() didn't set 
                 new_control->next");
